...
public class BaseTest {
    ...
    public void SetUp() throws MalformedURLException {
        if(localAndroid){
            System.out.println("!!!!!! Android test is starting to run on local... !!!!!!");
            ...
            System.out.println("IOS Test is Beginning");
            DesiredCapabilities desiredCapabilities = new DesiredCapabilities();
            desiredCapabilities
            ...
            desiredCapabilities
                    .setCapability(MobileCapabilityType.PLATFORM_VERSION, "14.7.1");
            desiredCapabilities
